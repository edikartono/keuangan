...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['tambah_pengeluaran'])) {
    ...
    if ($stmt->execute()) {
        $_SESSION['flash_message'] = ['type' => 'success', 'message' => 'Pengeluaran berhasil ditambahkan.'];
...
$kategori_pemasukan = $conn->query("SELECT * FROM kategori WHERE tipe = 'Pengeluaran' ORDER BY nama_kategori ASC");
...
<div class="card shadow-sm">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="bi bi-cash-coin me-1"></i> Daftar Pengeluaran</h5>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered table-striped" id="pengeluaranTable">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" name="sumber_id" id="edit_sumber" required>
              <?php
